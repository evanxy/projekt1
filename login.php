...
<?php include_once "template/menu.php" ?>
        <div class="grid-x grid-padding-x">
          <div class="large-4 cell text-center">
            <form class="callout text-center" action="auth.php" method="post">
              <h1>Prijava</h1>
              <div class="floated-label-wrapper">
                <label for="user">Korisnik</label>
                <input autocomplete="off" type="text" id="user" name="user" placeholder="E-mail">
              </div>
              <div class="floated-label-wrapper">
                <label for="lozinka">Lozinka</label>
                <input autocomplete="off" type="password" id="lozinka" name="lozinka" placeholder="Password">
              </div>
